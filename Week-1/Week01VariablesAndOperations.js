...
console.log("The number of seats left on this plane: ", availableSeats);

console.log("Step 2:  Cost of Groceries");
let totalCost = 65.91;
console.log("Total cost of groceries today: ", totalCost);
...
console.log("It is hot outside today: ", hotOutside);
...
let streetAddress = "12 3Racha Ave";
...
console.log("New grocery total is: ", totalCost + 2.15);

    console.log('Fix a Birth Certificate:')
//	A birth certificate was printed incorrectly, change the middle initial to something else
//  ↓ YOUR CODE HERE ↓
middleInitial = 'X';
console.log("Birth certificate has been correted. Middle Initial: ", middleInitial);
...
//  ↓ YOUR CODE HERE ↓
let fullName = firstName + " " + middleInitial + " " + "Libit";
